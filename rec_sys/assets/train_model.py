from dagster import asset, Config, AssetIn, multi_asset, AssetOut, AssetKey, AssetExecutionContext, OpExecutionContext, Int, Float
import pandas as pd
...
@multi_asset(
    ...
    ins={
        ...
        key=AssetKey(["scores_movies_users"]), input_manager_key= "postgres_io_manager"
        )
    },
    outs={
